package com.example.cubaangularmaterial;
...
public class CubaangularmaterialTestContainer extends TestContainer {

    public CubaangularmaterialTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/example/cubaangularmaterial/app.properties",
    ...
    public static class Common extends CubaangularmaterialTestContainer {

        public static final CubaangularmaterialTestContainer.Common INSTANCE = new CubaangularmaterialTestContainer.Common();
